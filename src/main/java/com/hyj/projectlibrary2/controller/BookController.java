...
public class BookController {
    ...
    public ModelAndView queryBookDo(String searchWord) throws UnsupportedEncodingException {
    ...
    public String addBookDo(@RequestParam(value = "pubstr") String pubstr, Book book, RedirectAttributes redirectAttributes) throws UnsupportedEncodingException {
        book = stringToUTF8.transferBookToUTF8(book);
    ...
    public String bookEditDo(@RequestParam(value = "pubstr") String pubstr, Book book, RedirectAttributes redirectAttributes) throws UnsupportedEncodingException {
        book = stringToUTF8.transferBookToUTF8(book);
        book.setPubdate(getDate(pubstr));
